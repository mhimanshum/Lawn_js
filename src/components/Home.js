    ...
    <>
      <div>
        <div className=" flex gap-7 justify-between ml-20 mr-20 mt-20">
          <div className=" hover:skew-y-3 origin-top-left bg-white shadow-lg hover:-translate-y-1 hover:scale-110  duration-300 ... shadow-black w-96 h-80">
          ...
          <div className=" hover:skew-x-3 origin-bottom-right bg-white shadow-lg hover:-translate-y-1 hover:scale-110  duration-300 ... shadow-black  w-96 h-80">
